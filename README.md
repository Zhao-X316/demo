...
> 2026-07-15：独立分支 `codex/t2-artifacts@3203be4` 已完成 T2～T6 和 B3a0 有序归组。老师只点选需重拍页；现在可为当前待重拍页单独选择新 JPEG，旧原图和旧激活快照保留，新页追加 replacement revision。同一学生多页待重拍时，最后一页补齐后才原子建立整组正式归属，其他学生不移动，也不会生成分数、发布或学习证据。机器质量/语义页型/题区/答题格、答题卡 OMR、默写 OCR、答案结构化与三类真实黄金集仍未完成；未 tag、合并、推送或发布。
