import { AppModule, DashboardTargetView, ClassTeachingEvent } from "../api/classDashboard";
import { useClassDashboardController } from "./class-dashboard/useClassDashboardController";
import { profileCellClass, PROFILE_STATUS, formatDelta, tagClass } from "./class-dashboard/shared";
import { ClassTeachingInputBuilder } from "./class-dashboard/ClassTeachingInputBuilder";
import { ClassProfileNodeDetails } from "./class-dashboard/ClassProfileNodeDetails";
          ...
          <section className="dashboard-panel class-profile-panel">
            ...
            {profileSnapshot && (
              <>
                ...
                <div className="class-profile-grid">
                  <section className="class-profile-common">
                    <div className="dashboard-panel-head">
                      ...
                      <button
                        className="primary"
                        onClick={() => setShowTeachingInputBuilder((value) => !value)}
                      >
                        {showTeachingInputBuilder ? "收起教学重点" : "生成本次教学重点"}
                      </button>
                    </div>
                ...
                {showTeachingInputBuilder && (
                  <ClassTeachingInputBuilder
                    snapshot={profileSnapshot}
                    commonNodeCount={commonTeachingInputCount}
                    onClose={() => setShowTeachingInputBuilder(false)}
                  />
                )}
