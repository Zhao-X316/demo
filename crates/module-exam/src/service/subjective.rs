//! 答题卡填空/简答题区的转写、机器评分建议与老师复核。
//!
//! 转写保存“学生实际写了什么”；机器评分与老师终审引用具体 active revision，
//! 避免答案反向污染 OCR 原文。accepted_answers 与 rubric_evidence 分别负责
//! 将老师确认内容晋级到未来版本，不回写当前作答的成绩或发布记录。

mod accepted_answers;
mod rubric_evidence;

pub use accepted_answers::promote_fill_accepted_answer;
pub use rubric_evidence::promote_short_answer_rubric_evidence;
