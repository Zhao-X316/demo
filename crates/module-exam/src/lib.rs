...
static MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        id: "exam_0028",
        sql: include_str!("../migrations/0028_subjective_component_grading.sql"),
    },
    Migration {
        id: "exam_0029",
        sql: include_str!("../migrations/0029_assessment_targets.sql"),
    },
    Migration {
        id: "exam_0030",
        sql: include_str!("../migrations/0030_assessment_schedule.sql"),
    },
    Migration {
        id: "exam_0031",
    ...
    Migration {
        id: "exam_0035",
        sql: include_str!("../migrations/0035_rubric_evidence_promotions.sql"),
    },
    Migration {
        id: "exam_0036",
        sql: include_str!("../migrations/0036_question_impact_review_cases.sql"),
    },
    Migration {
        id: "exam_0037",
